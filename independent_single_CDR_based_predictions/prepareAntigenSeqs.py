...
with open('data_prev/asPICKLE/data_filter.pickle', 'rb') as binary_reader:
...
fasta_file_path = 'data_prev/asFASTA/nanobody_seqs_98.fasta'
PDB = ''
PDBs = []
...
with open('data_prev/asPICKLE/data_filter_nano_identiy98.pickle', 'wb') as binary_writer:
    pickle.dump(data_filter_nano_identiy98, binary_writer)

# write the antigen sequences as FASTA file
antigen_seqs_fasta = open("data_prev/asFASTA/antigen_seqs_after_nanobody_identiy98.fasta", "w")
