...
clstr_file_path = 'data_prev/asFASTA/antigen_seqs_after_nanobody_identiy98_90.fasta.clstr'
...
with open('data_prev/asPICKLE/intra_group_binding.pickle', 'wb') as binary_writer:
...
with open('data_prev/asPICKLE/inter_group_binding.pickle', 'wb') as binary_writer:
