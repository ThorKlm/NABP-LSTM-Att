...
with open('data_prev/asPICKLE/clusters.pickle', 'rb') as binary_reader:
    clusters = pickle.load(binary_reader)

with open('data_prev/asPICKLE/intra_group_binding.pickle', 'rb') as binary_reader:
    intra_group_binding = pickle.load(binary_reader)

with open('data_prev/asPICKLE/inter_group_binding.pickle', 'rb') as binary_reader:
...
with open('data_prev/asPICKLE/train_data_pos.pickle', 'wb') as binary_writer:
    pickle.dump(train_data_pos, binary_writer)
with open('data_prev/asPICKLE/val_data_pos.pickle', 'wb') as binary_writer:
    pickle.dump(val_data_pos, binary_writer)
with open('data_prev/asPICKLE/test_data_pos.pickle', 'wb') as binary_writer:
    pickle.dump(test_data_pos, binary_writer)

with open('data_prev/asPICKLE/train_data_neg.pickle', 'wb') as binary_writer:
    pickle.dump(train_data_neg, binary_writer)
with open('data_prev/asPICKLE/val_data_neg.pickle', 'wb') as binary_writer:
    pickle.dump(val_data_neg, binary_writer)
with open('data_prev/asPICKLE/test_data_neg.pickle', 'wb') as binary_writer:
    pickle.dump(test_data_neg, binary_writer)

print('size of pos data_prev is ', total_pos)
print('size of train pos data_prev is ', str(len(train_data_pos)))
print('size of val pos data_prev is ', str(len(val_data_pos)))
print('size of test pos data_prev is ', str(len(test_data_pos)))

print('size of neg data_prev is ', str(len(neg_data)))
print('size of train neg data_prev is ', str(len(train_data_neg)))
print('size of val neg data_prev is ', str(len(val_data_neg)))
print('size of test neg data_prev is ', str(len(test_data_neg)))
...
with open('data_prev/asPICKLE/train_data_all.pickle', 'wb') as binary_writer:
    pickle.dump(train_data_all, binary_writer)
with open('data_prev/asPICKLE/val_data_all.pickle', 'wb') as binary_writer:
    pickle.dump(val_data_all, binary_writer)
with open('data_prev/asPICKLE/test_data_all.pickle', 'wb') as binary_writer:
    pickle.dump(test_data_all, binary_writer)

print('size of train data_prev is ', str(len(train_data_all)))
print('size of val data_prev is ', str(len(val_data_all)))
print('size of test data_prev is ', str(len(test_data_all)))
...
with open('data_prev/asPICKLE/train_CDR_antigen.pickle', 'wb') as binary_writer:
    pickle.dump(train_CDR_antigen, binary_writer)
with open('data_prev/asPICKLE/val_CDR_antigen.pickle', 'wb') as binary_writer:
    pickle.dump(val_CDR_antigen, binary_writer)
with open('data_prev/asPICKLE/test_CDR_antigen.pickle', 'wb') as binary_writer:
    pickle.dump(test_CDR_antigen, binary_writer)


print('size of train_CDR_antigen data_prev is ', str(len(train_CDR_antigen)))
print('size of val_CDR_antigen data_prev is ', str(len(val_CDR_antigen)))
print('size of test_CDR_antigen data_prev is ', str(len(test_CDR_antigen)))
